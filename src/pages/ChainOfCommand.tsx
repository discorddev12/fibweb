...
const ranks = [
  {
    ...
    members: [
      ...
      { rank: "1S-02 — Deputy Director", name: "Davis", role: "Responsibilities as deputy director include assisting the director and leading prominent investigations. All other FIB executives and special agents in charge report to the director through the deputy director." },
      ...
      { rank: "1S-04 — Deputy Chief of Staff", name: "O.Dory", role: "Is the 4th in command of the FIB, supports executives in their roles. Takes part on small responsibilities while also strategically and smoothly plan processes across the FIB department to ensure dedicated experience." },
      { rank: "1S-05 — Associate Deputy Director", name: "Oscatt", role: "Takes part as 5th in command of the FIB, they have the responsibility for any hands-on management activities. Handle daily basic responsibilities and tasks to keep FIB department running smoothly and consistently. They also typically set and communicate different goals to have the department run smoothly." },
    ],
  },
  {
    ...
    icon: Award,
    members: [
      { rank: "2S-06 → 2S-11 — Special Coordinator", name: "T.Williams, Layla", role: "The Special Coordinators is a big step, they are tasked with helping with our daily and weekly task from posting Song of the Day to our weekly promotions. They are the Department Heads right hand when getting our tasks completed." },
    ],
  },
  {
    tier: "Low Command",
